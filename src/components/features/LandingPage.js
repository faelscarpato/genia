      ...
      <section className="py-xl bg-surface-container-low" id="features">
        <div className="container-max mx-auto px-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-lg auto-rows-[280px]">
            ...
            {/* Feature 3: Sistema de Confiança */}
            ...
            <div className="order-1 lg:order-2 space-y-lg">
              ...
              <div className="space-y-md">
                <div className="flex gap-md">
                  <span className="material-symbols-outlined text-secondary" style={{ fontVariationSettings: "'FILL' 1" }}>privacy_tip</span>
                  <div>
                    <h4 className="font-title-lg text-title-lg mb-xs">Conformidade LGPD</h4>
                    <p className="font-body-md text-body-md text-on-surface-variant">Cumprimos os mais altos padrões de proteção de dados pessoais e privacidade.</p>
                  </div>
                </div>
                <div className="flex gap-md">
                  <span className="material-symbols-outlined text-secondary" style={{ fontVariationSettings: "'FILL' 1" }}>encrypted</span>
                  <div>
                    <h4 className="font-title-lg text-title-lg mb-xs">Criptografia de Ponta</h4>
                    <p className="font-body-md text-body-md text-on-surface-variant">Seus documentos e árvores são protegidos por criptografia de nível bancário.</p>
                  </div>
                </div>
                <div className="flex gap-md">
                  <span className="material-symbols-outlined text-secondary" style={{ fontVariationSettings: "'FILL' 1" }}>cloud_done</span>
                  <div>
                    <h4 className="font-title-lg text-title-lg mb-xs">Propriedade de Dados</h4>
                    <p className="font-body-md text-body-md text-on-surface-variant">Você é o único dono das suas descobertas. Exporte tudo quando quiser.</p>
                  </div>
                </div>
              </div>
            </div>
