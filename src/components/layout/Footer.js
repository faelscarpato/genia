      ...
      <div className="container-max mx-auto px-lg">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-xl mb-xl">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant">Digital Archive Excellence. Transformando o passado em legado digital através da tecnologia.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex gap-xs">
              <input className="flex-1 bg-surface-container-low border border-outline-variant rounded-lg px-md py-sm text-label-md font-label-md" placeholder="Seu e-mail" type="email" />
              <button className="bg-primary text-on-primary p-sm rounded-lg hover:bg-primary/90">
        ...
        <div className="pt-lg border-t border-outline-variant flex flex-col md:flex-row justify-between items-center gap-md">
          <p className="font-label-md text-label-md text-on-surface-variant">© 2024 Ancestry AI. Todos os direitos reservados.</p>
